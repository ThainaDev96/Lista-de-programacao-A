...
public class exercicio31 {
    ...
    public static void main(String[] args) {
        ...
        /*31. Um funcionário recebe um salário fixo mais 4% de comissão sobre as vendas. Faça um programa que receba
o salário fixo de um funcionário e o valor de suas vendas, calcule e mostre a comissão e o salário final do 
funcionário.*/


String salario_s, valorVendas_s;
float salario = 0, valor_vendas = 0, comissao = 0.04f, salario_final;
